...
###WHAT columns do the old  (ndvi.avg.threshold", "gndvi.avg.threshold", "gdvi2.avg.threshold) correspond to now?

# 1 predictor, VI
pred1 <- c("NDVI.CI", "GNDVI.CI", "GDVI2.CI", #changed from p*values to new variables
