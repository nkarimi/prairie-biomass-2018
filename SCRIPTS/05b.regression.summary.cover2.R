...
# 1 predictor, VI
pred1 <- c("NDVI.CI", "GNDVI.CI", "GNDVI.CI") #changed from "pNDVIvalues", "pGNDVIvalues", "pGDVI2values"
...
pred2.1 <- c("NDVI.CI", "GNDVI.CI", "GNDVI.CI") #changed from "pNDVIvalues", "pGNDVIvalues", "pGDVI2values"
...
# format a few things
#does this need to be done if I chnaged above variables??
